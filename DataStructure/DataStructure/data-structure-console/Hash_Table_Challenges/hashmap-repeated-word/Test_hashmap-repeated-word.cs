...
namespace Test_Repeated_Word
{
    ...
    {
        Repeated_Word.hashmap_repeated_word hashmapRepeatedWord = new Repeated_Word.hashmap_repeated_word();

        [Fact]
        public void Test1()
        {
            string text = "Once upon a time, there was a brave princess who...";
            Assert.Equal("a", hashmapRepeatedWord.repeatedWord(text));
        }
        [Fact]
        public void Test2()
        {
            ...
            Assert.Equal("it", hashmapRepeatedWord.repeatedWord(text));
        }
        [Fact]
        public void Test3()
        {
            ...
            Assert.Equal("summer", hashmapRepeatedWord.repeatedWord(text));
        }

        [Fact]
        public void Test4()
        {
            string text = "Car House Market Name Ball Soccer Work ..";
            Assert.Equal("There is no repeated word ..", hashmapRepeatedWord.repeatedWord(text));
        }
    }
}